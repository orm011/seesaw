        ...
        if self.params.interactive == 'textual':
          ...
          config = {'batch_size': 64,
                  ...
                  'opt_config': {'logit_scale': {'lr': 0.0001415583047102676,
                    ...
                    'transformer': None,
                    'transformer.resblocks.0.ln_': {'lr': 0.0007435612322566577,
                    'weight_decay': 1.5959136512232553e-05},
                    'transformer.resblocks.11': {'lr': 0.0001298217305130271,
                    'weight_decay': 0.015548602355938877},
                    'transformer.resblocks.11.mlp': {'lr': 3.258792283209162e-07,
                    'weight_decay': 0.001607367028678558},
                    'transformer.resblocks.11.ln_2': None,
                    'ln_final': {'lr': 0.007707377565843718,
                    'weight_decay': 0.0},
