...
_session_modes = {
  'base':SessionParams(index_spec={'d_name':'', 'i_name':'coarse'},
          ...
          batch_size=3),
  'fine':SessionParams(index_spec={'d_name':'', 'i_name':'multiscale'},
          interactive='plain', 
          method_config=_method_configs['plain'],
          agg_method='avg_vector',
          batch_size=3),
  'pytorch':SessionParams(index_spec={'d_name':'', 'i_name':'multiscale'}, ## seesaw
          interactive='pytorch', 
          method_config=_method_configs['pytorch'],
          agg_method='avg_vector',
          batch_size=3),
  'textual':SessionParams(index_spec={'d_name':'', 'i_name':'multiscale'},
          interactive='textual', 
