...
clip_model = CLIPModel.from_pretrained("/home/gridsan/groups/fastai/omoll/seesaw_root2/models/clip-vit-base-patch32/")
...
def get_proposal_boxes(paths, save_path, clip = False, image_limiter = None, box_limiter = 100, padding = 10): 
    ims = []
